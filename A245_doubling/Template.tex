...
This section follows the work by \textcite{meschede/optik_licht_laser/2008}.
Verbatim copies of equations will be cited additionally.
...
amplitude which depends on the distance of $\omega$ from $\omega_0$. The linear
force is a good approximation until ones uses high intensity laser beams. Then
one needs to include the next term in the force expansion, $\alpha x^2$.
