...
\[
    ...
    \xi) \,.
\]
Here $l$ is the crystal length, $\xi = l / b$ is the normalized crystal length
and $h(0, \xi)$ is the Boyd-Kleinman reduction factor in the case of
\SI{90}{\degree} phase matching. For $\xi = 2.84$ the function $h(0, \xi)$
...
>>}$. Given the large error margin it could be anything. One could say that it
is close to the optimal value of \num{2.84}.
