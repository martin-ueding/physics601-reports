...
crystal in the beam. After doing this we were able to measure some
\SI{40}{\micro\watt} of blue light.
...
\]
Error estimation is done via resampling. The fit clearly has a very high
$\chi^2$, the sinc-model does not describe the data well.
