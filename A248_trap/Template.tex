...
signal can be obtained using polarization spectroscopy. As the name implies
this kind of spectroscopy uses the probe beam's polarization rather than its
intensity. The reason for this is, that one can detect small changes in
polarization much better than small changes in intensity.
...
and of the spectroscopy cell, which are crossed, so that the background
