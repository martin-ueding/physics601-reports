...
\begin{figure}
    ...
    \caption{%
        ...
        photodiode is voltage measured at the oscilloscope. We have rescaled by
        a factor hundred as the absolute value is not meaningful anyway. The
        red line is a rising exponential fit.
        }
    \label{fig:loading}
\end{figure}
