...
After that the signals are counted in two counters (\textsc{n(lr)} and
\textsc{n(rl)}) depending on the moving direction of the absorber.
...
\omega_0 (1 + v/c)$, the lines are remarkably sharp.
...
\begin{table}
    ...
    \begin{tabular}{SSS}
        ...
        \bottomrule
    \end{tabular}
    \caption{Fit parameters and errors for the Lorentz dips}
    \label{tab:fit}
\end{table}
