...
\begin{tikzpicture}[
    ...
    \coordinate[right=4.9 of e1] (e1e);
    \coordinate[right=4.9 of e2] (e2e);
    \coordinate[right=4.9 of e3] (e3e);
    \coordinate[right=4.9 of e4] (e4e);

    \coordinate[right=4.9 of f1] (f1e);
    \coordinate[right=4.9 of f2] (f2e);
    ...
    \draw[transition] ($(f1)+1*(0.7,0)$)-- node[number] {1} ($(e4)+1*(0.7,0)$);
    \draw[transition] ($(f1)+2*(0.7,0)$)-- node[number] {2} ($(e3)+2*(0.7,0)$);
    \draw[transition] ($(f2)+3*(0.7,0)$)-- node[number] {3} ($(e3)+3*(0.7,0)$);
    \draw[transition] ($(f1)+4*(0.7,0)$)-- node[number] {4} ($(e2)+4*(0.7,0)$);
    \draw[transition] ($(f2)+5*(0.7,0)$)-- node[number] {5} ($(e2)+5*(0.7,0)$);
    \draw[transition] ($(f2)+6*(0.7,0)$)-- node[number] {6} ($(e1)+6*(0.7,0)$);


    \node[draw, below right=0.6 and 0.75 of b1, anchor=north] {$B = 0$ \\ $Q = 0$};
    \node[draw, below right=0.4 and 0.75 of d2, anchor=north] {$B \neq 0$ \\ $Q = 0$};
    \node[draw, below right=0.4 and 2.45 of f2, anchor=north] {$B \neq 0$ \\ $Q \neq 0$};
