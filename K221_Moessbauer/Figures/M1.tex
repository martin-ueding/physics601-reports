\begin{tikzpicture}[
    ...
    \draw[transition] (0.3, 0) -- ++(0, -2.9);
    \draw[transition] (0.5, -0.5) -- ++(0, -2.4);
    \draw[transition] (0.7, -1) -- ++(0, -1.9);

    \draw[transition] (1.3, -0.5) -- ++(0, -3.1);
    \draw[transition] (1.5, -1) -- ++(0, -2.6);
    \draw[transition] (1.7, -1.5) -- ++(0, -2.1);
