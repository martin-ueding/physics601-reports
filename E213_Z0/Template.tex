...
The other characteristics, \pcharged\ as well as \eecal\ and \ehcal, were also
plotted using \textsc{paw}. The energy in charged tracks is shown in
Figure~\ref{fig:paw-pcharged}. The deposited energies are in
Figure~\ref{fig:paw-e_ecal} for the \eecal\ and Figure~\ref{fig:paw-e_hcal} for
the \ehcal.
