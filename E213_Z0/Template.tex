...
asymmetric errors using the percentiles of the bootstrapped distribution.
...
As the bootstrap gives us hundreds of fit parameters, we can take mean and
standard deviation to obtain an realistic error estimate for the resulting fit
parameters. Just taking the diagonal of the covariance matrix of a
least-squares fit greatly underestimates the error in most cases.
