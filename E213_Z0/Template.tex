...
% TODO Table with out names, GROPE and PAW names.
...
handled using a detection efficiency matrix~$\mat E$ and Monte Carlo datasets.
...
vector $\vec I$ (same space). The efficiency matrix is then defined via $\vec I
= \mat E \vec A$. In order to find the sixteen matrix elements, we apply a
