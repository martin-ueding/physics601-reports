...
From here, we can compute the decay widths of the individual channels.

% TODO

\SIlist{<< width_electron >>}{\giga\electronvolt}

\SIlist{<< ';'.join(width_flavors) >>}{\giga\electronvolt}
