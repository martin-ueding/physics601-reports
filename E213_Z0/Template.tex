...
\begin{figure}
    ...
    \caption{%
        ...
        \hcal{}. Muon penetrations are indicated with red arrows.
    }
    \label{fig:opal}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{mpl-normalized_matrix}
    \caption{%
        %
    }
    \label{fig:mpl-normalized_matrix}
\end{figure}
